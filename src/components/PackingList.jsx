  ...
  if (packingItems.length === 0) {
    return (
      <div style={{ textAlign: 'center', padding: '32px 16px' }}>
        ...
        <div style={{ fontSize: 13, color: '#9A8B94', marginBottom: 8, lineHeight: 1.5 }}>
        ...
        <div style={{
          ...
          {event.capacite && <Badge color="#E8935A">{event.capacite} pers.</Badge>}
    ...
    <div>
      ...
      {shortageItems.length > 0 && (
        <div className="card" style={{
          ...
          background: '#FDF0F4', border: '1.5px solid #D4648A25',
        }}>
          <div style={{ fontSize: 12, fontWeight: 800, color: '#D4648A', marginBottom: 4 }}>
            Manque de stock
          </div>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4, marginTop: 6 }}>
            ...
            {shortageItems.length > 5 && (
              <span style={{ fontSize: 10, color: '#B8A0AE' }}>+{shortageItems.length - 5} autres</span>
            )}
          </div>
        </div>
      )}
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                  ...
                  {roleShortages > 0 && (
                    <span style={{
                      ...
                      background: '#D4648A', color: 'white', fontWeight: 800,
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                  {items.map(item => {
                    ...
                    const statusColor = item.packed ? '#5DAB8B'
                      : item.quantity_packed > 0 ? '#E8935A' : '#D4648A'
                    const statusBg = item.packed ? '#EDF7F2'
                      : item.quantity_packed > 0 ? '#FFF5EB' : '#FDF0F4'
                      ...
                      <div key={item.id} className="card" style={{
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 2 }}>
                            <span style={{ fontSize: 10, color: '#B8A0AE' }}>{p.sku || ''}</span>
                            {item.shortage > 0 && (
                              <span style={{
                                fontSize: 9, padding: '1px 5px', borderRadius: 4,
                                background: '#D4648A15', color: '#D4648A', fontWeight: 800,
                              }}>
